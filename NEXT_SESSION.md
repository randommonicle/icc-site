...
**FIRST ACTION NEXT SESSION (Ben decided, 18 Sept late evening): set the hosted Supabase auth config for the password flow, through the Management API, before anything else.** Established this evening (verified unless marked):
