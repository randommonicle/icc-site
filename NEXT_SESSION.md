...
**Not done, on purpose.** The other 14 Sept copy proposals (A, B, C, D1 to D10 wording, E1, E3 to E8, F, G1 to G3) are still decisions for Ben, recorded in `docs/BOOKING_PAGE_COPY_REVIEW_2026-09-14_v2.md`; only B-1 (last session), B-3, E2 and G4 have been acted on. The D9 "secure your slot" wording stays as it was (the mechanics-vs-words decision is Ben and Mark's). SEO items left open by choice: O-01 (home H1 wording, owner call), O-05 (internal linking), S-01 (`Article` image + `datePublished`), the T-10 font note, S-07's validator runs. The email links to `/privacy` (`privacyNoticeUrl`) keep the slash-less form: not crawled, and a change would touch four tests for no SEO gain.
