...
- [ ] **Operator assistant turn headroom** (first live ride, 16 Sept 2026, L-042): cold first turns and two-tool questions hit the 8.5 s deadline; warm one-tool turns take 4.3 to 6.5 s. Trim the turn, pre-warm on login, or move to a background function; decide before Mark relies on it.
